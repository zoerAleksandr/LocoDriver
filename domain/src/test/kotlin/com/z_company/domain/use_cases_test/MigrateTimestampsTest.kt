...
class MigrateTimestampsTest {
    ...
    private class FakeRouteRepository(initialRoutes: List<Route> = emptyList()) : RouteRepository {
        ...
        override fun loadOtherWork(otherWorkId: String): Flow<ResultState<com.z_company.domain.entities.route.OtherWork?>> = flow { emit(ResultState.Success(null)) }
        override fun loadOtherWorkListByBasicId(basicId: String): List<com.z_company.domain.entities.route.OtherWork> = emptyList()
        ...
        override fun saveOtherWork(otherWork: com.z_company.domain.entities.route.OtherWork): Flow<ResultState<Unit>> = flow { emit(ResultState.Success(Unit)) }
