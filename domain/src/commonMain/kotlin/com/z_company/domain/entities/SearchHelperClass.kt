...
data class FilterSearch(
    ...
    val partnerData: Pair<String, Boolean> = Pair(FilterNames.PARTNER_DATA.value, true),
...
enum class SearchTag {
    BASIC_DATA, LOCO, TRAIN, PASSENGER, OTHER_WORK, PARTNER, NOTES
}
