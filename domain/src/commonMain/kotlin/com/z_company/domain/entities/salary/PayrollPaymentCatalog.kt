...
object PayrollPaymentCatalog {
    val entries: List<PayrollPaymentDefinition> = listOf(
        ...
        accrual(SalaryPaymentId.ONE_PERSON_FREIGHT, emptyList(), "Доплата за работу без помощника машиниста", "В одно лицо (грузовые)"),
        accrual(SalaryPaymentId.ONE_PERSON_PASSENGER, emptyList(), "Доплата за работу без помощника машиниста", "В одно лицо (пассажирские)"),
        ...
        accrual(SalaryPaymentId.EXTENDED_SERVICE, emptyList(), "Доплата за удлинённое плечо", "Удлинённое плечо"),
        accrual(SalaryPaymentId.HEAVY_TRAIN, "152Р", "ДоплРабЛокомБрТяжДлинПоез", "Тяжёлые поезда"),
        accrual(SalaryPaymentId.LONG_TRAIN, "152Р", "ДоплРабЛокомБрТяжДлинПоез", "Длинносоставные поезда"),
