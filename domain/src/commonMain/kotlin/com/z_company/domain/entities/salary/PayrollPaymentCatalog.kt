...
object PayrollPaymentCatalog {
    val entries: List<PayrollPaymentDefinition> = listOf(
        ...
        accrual(SalaryPaymentId.HEAVY_TRAIN, "152L", "ДоплРабЛокомБрТяжДлиннПое", "Тяжёлые поезда"),
        accrual(SalaryPaymentId.LONG_TRAIN, "152L", "ДоплРабЛокомБрТяжДлиннПое", "Длинносоставные поезда"),
