...
fun validExtendedServicePhaseSurcharges(
...
fun isFederalLaw144Effective(year: Int, month: Int): Boolean =
    year > 2026 || (year == 2026 && month >= 8)

fun isExpandedOvertimeBaseEffective(year: Int, month: Int): Boolean =
