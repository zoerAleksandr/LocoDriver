...
/**
 * Экран настройки зарплаты — редактирование всех числовых полей [SalarySetting].
 *
 * Поля сгруппированы по карточкам: Основные, Надбавки, Удержания.
 * Кнопка «Сохранить» (галочка в TopAppBar) сохраняет и возвращает назад.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
internal fun SettingSalaryScreen(router: Router) {
    val viewModel: SettingSalaryIosViewModel = koinInject()
...
private fun SalaryDoubleField(
    ...
    // Keep a local string so partial input (e.g. "1.") doesn't get reformatted
