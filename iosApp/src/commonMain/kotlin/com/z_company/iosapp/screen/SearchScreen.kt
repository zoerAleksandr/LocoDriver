...
@Composable
internal fun SearchScreen(router: Router) {
    val viewModel: SearchIosViewModel = koinInject()
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                keyboardActions = KeyboardActions(
                    onSearch = { /* поиск уже происходит при вводе */ },
                ),
...
private fun SearchResultCard(route: Route, onClick: () -> Unit) {
    ...
    Card(
        ...
        Column(modifier = Modifier.padding(12.dp)) {
            // Header row: number + duration badge
            Row(
