                ...
                Card(
                    ...
                    Column(
                        ...
                        SummaryRow(
                            ...
                            value = TimeFormatter.formatDurationHHMM(s.totalWorkMs),
                        )
                        SummaryRow(
                            label = "Ночное время",
                            value = TimeFormatter.formatDurationHHMM(s.totalNightMs),
                        )
                        SummaryRow(
                            label = "Время перерывов",
                            value = TimeFormatter.formatDurationHHMM(s.totalBreakMs),
                        )
                    }
                }
            }

            // Per-route breakdown section
...
/**
 * A small stat card showing a title and value.
 */
@Composable
