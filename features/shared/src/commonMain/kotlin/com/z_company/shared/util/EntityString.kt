...
/**
 * KMP-compatible replacement for core_android EntityString.
 *
 * Converts domain entities to human-readable strings for search indexing.
 */
class EntityString(setting: UserSettings, timeZoneId: String) {
    private var dateAndTimeConverter: DateAndTimeConverter = DateAndTimeConverter(timeZoneId)
