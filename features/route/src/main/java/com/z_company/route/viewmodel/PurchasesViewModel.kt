...
//                val products: MutableList<Product> = ruStorePayClient.products.getProducts(
//                    productIds = availableProductIds
//                ).await().toMutableList()
//                val purchases = ruStorePayClient.purchases.getPurchases().await()
//
...
//                                        ruStorePayClient.purchases.deletePurchase(purchaseId)
//                                            .await()
//                                    }
//
//                                    PurchaseState.PAID -> {
//                                        ruStorePayClient.purchases.confirmPurchase(purchaseId)
//                                            .await()
//                                    }
//
//                                    else -> Unit
...
//        ruStorePayClient.purchases.purchaseProduct(
