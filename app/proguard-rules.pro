...
# VK ID 2.6.0 transitively includes tracer-lite 1.0.0-beta.1 without its
# optional tracer-base/tracer-lite modules. These references are guarded by
# the SDK at runtime; suppress the missing-class warnings generated by R8.
-dontwarn ru.ok.tracer.base.**
-dontwarn ru.ok.tracer.lite.**
