...
- Полноэкранный экран поверх приложения после сплэша: hero-иконка (ℹ) в
  тональном скруглённом квадрате, крупный заголовок (жирный), многострочный
  текст, внизу pill-кнопка **«Понятно»** во всю ширину. В правом верхнем углу —
  крестик закрытия. Тема-адаптив (`LocoDriverTheme`), длинный текст прокручивается.
- Тональный фон иконки — на `primary` с alpha (не `surfaceContainerHigh`,
  который в этой теме оранжевый).
