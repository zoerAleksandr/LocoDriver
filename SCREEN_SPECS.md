...
- При каждом открытии экрана при наличии авторизации и активной подписки тихо
  запускается двусторонняя облачная синхронизация. Пока она идёт, непосредственно
...
- При каждом открытии экрана при наличии авторизации и активной подписки тихо
  запускается двусторонняя облачная синхронизация. Под верхним app bar на время
