...
часовую базу повышенной оплаты сверхурочных.
...
Классность и вредность рассчитываются от оплачиваемых рабочих сегментов без
следования пассажиром: перерыв исключается общим конвейером, а денежная база
каждой части использует ставку, действовавшую до или после изменения тарифа.
Та же сегментная временная и тарифная база применяется к зональной и строке
«Другие надбавки»; их пользовательский процент не меняет состав базовых часов.
