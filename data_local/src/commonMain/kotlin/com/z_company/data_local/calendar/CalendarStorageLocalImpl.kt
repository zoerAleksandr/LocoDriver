    ...
    private val monthOfYearList = listOf(
        ...
        MonthOfYear(
            year = 2026, month = 0, days = listOf(
                ...
                Day(6, HOLIDAY),
                Day(7, HOLIDAY),
                Day(8, HOLIDAY), // новогодние каникулы
                Day(9, NON_WORKING_DAY),
                Day(10, NON_WORKING_DAY),
                Day(11, NON_WORKING_DAY),
                Day(12, WORKING_DAY),
        ...
        MonthOfYear(
            year = 2026, month = 1, days = listOf(
                ...
                Day(21, NON_WORKING_DAY),
                Day(22, NON_WORKING_DAY),
                Day(23, HOLIDAY), // День защитника Отечества
                Day(24, WORKING_DAY),
                Day(25, WORKING_DAY),
                Day(26, WORKING_DAY),
                Day(27, WORKING_DAY),
        ...
        MonthOfYear(
            year = 2026, month = 2, days = listOf(
                ...
                Day(6, WORKING_DAY),
                Day(7, NON_WORKING_DAY),
                Day(8, HOLIDAY), // Международный женский день
                Day(9, NON_WORKING_DAY),
                Day(10, WORKING_DAY),
                Day(11, WORKING_DAY),
                Day(12, WORKING_DAY),
        ...
        // май
        MonthOfYear(
            year = 2026, month = 4, days = listOf(
                Day(1, HOLIDAY), // Праздник Весны и Труда
                Day(2, NON_WORKING_DAY),
                Day(3, NON_WORKING_DAY),
                Day(4, WORKING_DAY),
                Day(5, WORKING_DAY),
        ...
        // ноябрь
        MonthOfYear(
            year = 2026, month = 10, days = listOf(
                Day(1, NON_WORKING_DAY),
                Day(2, WORKING_DAY),
                Day(3, SHORTENED_DAY),
                Day(4, HOLIDAY), // День народного единства
                Day(5, WORKING_DAY),
                Day(6, WORKING_DAY),
                Day(7, NON_WORKING_DAY),
                Day(8, NON_WORKING_DAY),
        ...
        // декабрь
        MonthOfYear(
            year = 2026, month = 11, days = listOf(
                Day(1, WORKING_DAY),
                Day(2, WORKING_DAY),
                Day(3, WORKING_DAY),
                Day(4, WORKING_DAY),
